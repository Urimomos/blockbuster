...
<?= $this->section('content') ?>
    ...
    <style>
        /* ================================================== */
        /* --- DISEÑO REGISTRO: ROBOT + CONSTELACIONES    --- */
        /* ================================================== */
        ...
        .login-wrapper {
            ...
            overflow: hidden;
            padding: 60px 20px; /* Un poco más de padding porque el formulario es más largo */
        }
        ...
        .combined-container {
            ...
            z-index: 10;
            width: 100%;
            max-width: 480px; /* Un poco más ancho para los nombres */
            display: flex;
        ...
        .robot-antenna {
            width: 6px; height: 20px; background: #b3b3b3; margin: 0 auto; position: relative;
        }
        .robot-led {
            width: 10px; height: 10px; background: #ff3333; border-radius: 50%;
            position: absolute; top: -8px; left: -2px; box-shadow: 0 0 8px #ff3333;
        ...
        .robot-head {
            width: 110px; height: 75px; background: #001A5E; border: 3px solid #FFCC00;
            border-radius: 15px; display: flex; justify-content: center; align-items: center;
            gap: 12px; box-shadow: 0 8px 15px rgba(0,0,0,0.5); position: relative; z-index: 2;
        }
        ...
        .robot-hand {
            width: 30px; height: 30px; background: #FFCC00; border-radius: 50%;
            position: absolute; bottom: -12px; z-index: 3; box-shadow: inset -2px -2px 0 rgba(0,0,0,0.2);
        ...
        /* ESTADO: CONTRASEÑA */
        .robot.hide-eyes .hand-left { transform: translateY(-55px) translateX(18px); }
        .robot.hide-eyes .hand-right { transform: translateY(-55px) translateX(-18px); }
        .robot.hide-eyes .robot-eye { height: 6px; margin-top: 8px; }
        ...
        .tech-input-group input::placeholder { color: #4a5c7c; }
        ...
        .tech-input-group input:focus + i.left-icon { color: #FFCC00; }
        ...
        .toggle-password:hover, .toggle-password:focus { color: #FFCC00; outline: none; }
        ...
        .tech-footer a:hover { color: #ffffff; text-decoration: underline; }

        .row-inputs {
            display: flex;
            gap: 15px;
        }
        .row-inputs .tech-input-group {
            flex: 1;
        }
